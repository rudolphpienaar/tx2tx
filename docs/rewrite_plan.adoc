...
- 2026-02-17: Phase 0 baseline scenarios documented in `docs/rewrite_baseline.adoc`.
- 2026-02-17: Phase 1 scaffolding started by extracting polling-loop orchestration to `tx2tx/server/runtime_loop.py` without intended behavior change.
