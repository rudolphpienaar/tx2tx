...
For GNOME truth-bridge development, review:

- `gnome_extension/tx2tx-truth-bridge/README.adoc`
- `tx2tx/wayland/gnome_truth_bridge.py`
...
GNOME Wayland server with truth-bridge pointer telemetry:
